...
public class BookOperation {
    public static List<Element> findBook(NodeList nodeList) {
        ...
        List<Element> books = nodes.stream()
                ...
                .filter(element -> {
                    ...
                    return author.equalsIgnoreCase("Автор ") && year.equals("1869");
                })
    ...
    public static void addNewBook(Document doc) {
        try {
            ...
            StreamResult result = new StreamResult(new File("C:\\Users\\munir\\IdeaProjects\\term_2\\src\\lab_10\\example_1\\example.xml"));
